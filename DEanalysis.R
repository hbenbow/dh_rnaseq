...
write.csv(all_significant_filtered, "~/Documents/S_L_DH/DEtesting/data/DE_tests/together_filter.csv", row.names=F)
write.csv(all_sig, "~/Documents/S_L_DH/DEtesting/data/together_no_filter.csv", row.names=F)
...
write.csv(RES_G1, file="~/Documents/S_L_DH/DEtesting/data/RES_G1.csv", row.names=F)
write.csv(RES_G2, file="~/Documents/S_L_DH/DEtesting/data/RES_G2.csv", row.names=F)
write.csv(RES_G3, file="~/Documents/S_L_DH/DEtesting/data/RES_G3.csv", row.names=F)
write.csv(RES_G4, file="~/Documents/S_L_DH/DEtesting/data/RES_G4.csv", row.names=F)
write.csv(RES_L1, file="~/Documents/S_L_DH/DEtesting/data/RES_L1.csv", row.names=F)
write.csv(RES_L2, file="~/Documents/S_L_DH/DEtesting/data/RES_L2.csv", row.names=F)
write.csv(RES_L3, file="~/Documents/S_L_DH/DEtesting/data/RES_L3.csv", row.names=F)
write.csv(RES_L4, file="~/Documents/S_L_DH/DEtesting/data/RES_L4.csv", row.names=F)
write.csv(RES_R1, file="~/Documents/S_L_DH/DEtesting/data/RES_R1.csv", row.names=F)
write.csv(RES_R2, file="~/Documents/S_L_DH/DEtesting/data/RES_R2.csv", row.names=F)
write.csv(RES_R3, file="~/Documents/S_L_DH/DEtesting/data/RES_R3.csv", row.names=F)
write.csv(RES_R4, file="~/Documents/S_L_DH/DEtesting/data/RES_R4.csv", row.names=F)
write.csv(RES_S1, file="~/Documents/S_L_DH/DEtesting/data/RES_S1.csv", row.names=F)
write.csv(RES_S2, file="~/Documents/S_L_DH/DEtesting/data/RES_S2.csv", row.names=F)
write.csv(RES_S3, file="~/Documents/S_L_DH/DEtesting/data/RES_S3.csv", row.names=F)
write.csv(RES_S4, file="~/Documents/S_L_DH/DEtesting/data/RES_S4.csv", row.names=F)

write.csv(T6,  "~/Documents/S_L_DH/DEtesting/data/T6.csv")
write.csv(T24, "~/Documents/S_L_DH/DEtesting/data/T24.csv")
write.csv(T48, "~/Documents/S_L_DH/DEtesting/data/T48.csv")
write.csv(T96, "~/Documents/S_L_DH/DEtesting/data/T96.csv")
